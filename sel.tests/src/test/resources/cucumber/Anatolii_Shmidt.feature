Feature: some functional on https://www.epam.com/ for "Testing and Development" course
  ...
  Scenario Outline: Check telephone format
    Given The user is on the contact page (https://www.epam.com/about/who-we-are/contact)
    When The user inputed <phone> that contains forbidden characters 
  ...
  Scenario: Show news for 2002
    ...
    When The user choose "2002" from Year list on the In The News page
  ...
  Scenario: Show business news for 2001
    ...
    When The user choose "2001" from Year list on the Press Releases page
