...
- Необхідний JDK версії 12 або 13, посилання: https://jdk.java.net/
...
Налаштування Eclipse:
 ...
 Запуск тестів
  ...
  Після налаштування для запуску всіх тестів необхідно вибрати Run As JUnit Test у списку біля Run(дефолтний значок запуску на панелі зверху). 
